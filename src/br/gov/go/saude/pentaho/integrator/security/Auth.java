...
public class Auth {
	...
	// TODO
	// Authentication based on the Google Authenticator TOTP (Time-based One-time
	// Password Algorithm)
	/*
	 * private String AuthTotp(String myToken, String myUrlEncoded) throws
	 * SQLException, Exception { return null; }
	 */
